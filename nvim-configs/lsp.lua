-- https://raw.githubusercontent.com/wookayin/dotfiles/master/nvim/lua/config/lsp.lua
-------------
-- LSP config
-------------
  ...
  formatting = {
    format = function(entry, vim_item)
      ...
      pcall(function()  -- protect the call against potential API breakage (lspkind GH-45).
        vim_item.kind =  class="pl-pds">" " .. require("lspkind").get_symbol(vim_item.kind) .. " " .. vim_item.kind
      end)
